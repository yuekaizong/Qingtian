...
insert into p1_cell(id,pid,img,title,description,href,data_target,view_more,position,content,name,value) values(301,3,"images/demo/author-ai.webp", 'Artificial Intelligence', 'description','http://hao123.com','dataTarget','viewMore','x=120,y=100','英文缩写为AI。它是研究、开发用于模拟、延伸和扩展人的智能的理论、方法、技术及应用系统的一门新的技术科学...','人工智能','值');
insert into p1_cell(id,pid,img,title,description,href,data_target,view_more,position,content,name,value) values(302,3,"images/demo/author-bigdata.webp", 'big data', 'description','http://hao123.com','dataTarget','viewMore','x=120,y=100','指无法在一定时间范围内用常规软件工具进行捕捉、管理和处理的数据集合，是需要新处理模式才能具有更强的决策力、洞察发现力和流程优化能力的海量、高增长率和多样化的信息资产...','大数据','值');
insert into p1_cell(id,pid,img,title,description,href,data_target,view_more,position,content,name,value) values(303,3,"images/demo/author-could.webp", 'cloud computing', 'description','http://hao123.com','dataTarget','viewMore','x=120,y=100','是基于互联网的相关服务的增加、使用和交付模式，通常涉及通过互联网来提供动态易扩展且经常是虚拟化的资源...','云计算','值');
