...
import kaizone.songmaya.qingtian.entity.TokenResult;
import kaizone.songmaya.qingtian.entity.UserInfoEntity;
import kaizone.songmaya.qingtian.jpa.TokenJPA;
import kaizone.songmaya.qingtian.jpa.UserInfoJPA;
...
public class TokenController {
    ...
    (
        ...
        //appSecret is null
            ...
            //验证appSecret是否存在
                ...
                token.setFlag(false);
                String appSecretStr = new String(userDbInfo.getAppSecret());
                token.setMsg("appSecret is not effective! appSecret="+appSecretStr);
            } else {
    ...
    private String createNewToken(String appId) {
        ...
        return Jwts
                ...
                .signWith(SignatureAlgorithm.HS256, "MyAuthV1.0.0")
                .compact();
    }
}
