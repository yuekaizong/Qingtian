...
@EnableJpaRepositories(
        ...
        transactionManagerRef = "transactionManagerBook", //事物管理引用
        basePackages = {"kaizone.songmaya.qingtian.book"}  //设置书籍数据源所应用到的包
)
public class BookDataSourceConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBook (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages(new String[]{ "kaizone.songmaya.qingtian.book" }) //设置应用creditDataSource的基础包名
